...
for(num=1; num<20; num++) // 탈출 조건 1
{
	...
	P[num][1] = ((-cpyA[1][0])*P[num-1][0]) + ((-cpyA[1][2])*P[num-1][2]) + ((-cpyA[1][3])*P[num-1][3]) + cpyA[1][4];
	P[num][2] = ((-cpyA[2][0])*P[num-1][0]) + ((-cpyA[2][1])*P[num-1][1]) + ((-cpyA[2][3])*P[num-1][3]) + cpyA[2][4];
	P[num][3] = ((-cpyA[3][0])*P[num-1][0]) + ((-cpyA[3][1])*P[num-1][1]) + ((-cpyA[3][2])*P[num-1][2]) + cpyA[3][4];

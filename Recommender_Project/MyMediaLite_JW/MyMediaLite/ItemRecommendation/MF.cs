...
namespace MyMediaLite.ItemRecommendation
{
	...
	public abstract class MF : IncrementalItemRecommender, IIterativeModel
	{
        ...
        //public void SavePredict(string file)
        //{
        //    List<Pairs> relevance = new List<Pairs>();
        //    Console.WriteLine(user_factors.NumberOfRows + "\t" + item_factors.NumberOfRows);
        //    for (int i = 0; i < user_factors.NumberOfRows; i++)
        //    {
        //        for (int j = 0; j < item_factors.NumberOfRows; j++)
        //        {
        //            float rating = Predict(i, j);
        //        }
        //    }
        //}

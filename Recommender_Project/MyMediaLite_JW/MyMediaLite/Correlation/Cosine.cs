...
namespace MyMediaLite.Correlation
{
    ...
    ///   </para>
    /// </remarks>
    public sealed class Cosine : SymmetricCorrelationMatrix, IRatingCorrelationMatrix
    {
        ...
        public Cosine(int num_entities, float shrinkage)
            : base(num_entities)
        {
            Shrinkage = shrinkage;
        }
        ...
        public float ComputeCorrelation(IRatings ratings, EntityType entity_type, int i, int j)
        {
            ...
            double pmcc = ij_sum / denominator;

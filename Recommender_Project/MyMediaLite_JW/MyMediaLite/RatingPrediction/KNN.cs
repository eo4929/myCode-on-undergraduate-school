...
namespace MyMediaLite.RatingPrediction
{
	...
	public abstract class KNN : IncrementalRatingPredictor
	{
		...
		void InitModel()
		{
            ...
            Correlation = RatingCorrelationType.BinaryCosine;
            ...
            switch (Correlation)
            {
                ...
                case RatingCorrelationType.Pearson:
                    ...
                    break;
                case RatingCorrelationType.Cosine:
                    correlation_matrix = new Cosine(num_entities, Alpha);
                    break;
                case RatingCorrelationType.SymmetricMatching:
                    correlation_matrix = new SymmetricMatching(num_entities);
                    break;
                case RatingCorrelationType.AsymmetricMatching:
                    correlation_matrix = new AsymmetricMatching(num_entities);
                    break;
                default:
                    throw new NotImplementedException(string.Format("Support for {0} is not implemented", Correlation));
            }
            //WeightedBinary = true;
            //Console.WriteLine(WeightedBinary);            

================================================================================
    MFC 라이브러리 : 2011688P5_1 프로젝트 개요
================================================================================

응용 프로그램 마법사에서 이 2011688P5_1 응용 프로그램을 
만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 
프로그램작성을 위한 기본 구조를 제공합니다.

이 파일에는 2011688P5_1 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.
...
2011688P5_1.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CMy2011688P5_1App 응용 프로그램
    클래스를 선언합니다.

2011688P5_1.cpp
    응용 프로그램 클래스 CMy2011688P5_1App이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\2011688P5_1.ico
    ...
    주 리소스 파일인 2011688P5_1.rc에 의해 포함됩니다.

res\My2011688P5_1.rc2
...
2011688P5_1Doc.h, 2011688P5_1Doc.cpp - 문서
    이 파일에는 CMy2011688P5_1Doc 클래스가 들어 있습니다. 이 파일을 편집하여
    특수한 문서 데이터를 추가하고 CMy2011688P5_1Doc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.

2011688P5_1View.h, 2011688P5_1View.cpp - 문서 뷰
    이 파일에는 CMy2011688P5_1View 클래스가 들어 있습니다.
    CMy2011688P5_1View 개체는 CMy2011688P5_1Doc 개체를 보는 데 사용됩니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더 파일(PCH)인 2011688P5_1.pch와

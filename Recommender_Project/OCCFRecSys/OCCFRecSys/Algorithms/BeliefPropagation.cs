...
namespace OCCFRecSys
{
    public class BeliefPropagation
    {
        ...
        {
            //List<Score> temp_belief_score_list = new List<Score>();
        ...
        /// <summary>
        /// target item에 대한 target user의 belief score를 계산  (target item 점수 계산 방법: 해당 아이템이 받는 메시지 점수 곱 * target item의 potential score)
        /// </summary>

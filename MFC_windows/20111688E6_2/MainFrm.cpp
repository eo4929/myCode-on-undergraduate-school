...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	if(!m_textDokingPane.Create(_T("Text Out"),this,CRect(0,0,150,150),TRUE,0xfafa,
		WS_CHILD | WS_VISIBLE | WS_CLIPSIBLINGS | WS_CLIPCHILDREN | CBRS_RIGHT | CBRS_FLOAT_MULTI))
	{
		TRACE0("도킹 팬을 만들지 못하였습니다.\n");
		return -1;
	}
	m_textDokingPane.SetMinSize(400);

	m_textDokingPane.EnableDocking(CBRS_ALIGN_ANY);
	DockPane(&m_textDokingPane);
